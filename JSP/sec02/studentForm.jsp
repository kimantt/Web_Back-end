...
<html>
	...
	<body>
		...
		<form name="frmStudent" method="post"  action="newStudentOk.jsp">
		 <table>
		   <!-- input 태그의 name 속성의 값과 서버에서 사용한 StudentBean 클래스의 속성명 일치 -->
	       ...
	       <tr><td>관심분야</td>
	                  <td><input type="checkbox"  id="web" value="웹프로그래밍" name="stdInterests">웹 프로그래밍
	                         <input type="checkbox"  id="design"  value="파이썬" name="stdInterests">파이썬
